...
contract PetPark {
    ...
    function borrow(uint _age, Gender _gender, AnimalType _animalType) public {
        ...
        Adopter memory adopter = adopters[msg.sender];
        if (adopter.age != 0) {
            require(adopter.gender == _gender, "Invalid Gender");
            require(adopter.age == _age, "Invalid Age");
        }
